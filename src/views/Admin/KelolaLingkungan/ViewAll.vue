<template>
  <div>
    <h1 class="page-title">Daftar Lingkungan</h1>
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      {
        text: 'Paroki', value: 'paroki_id',
      },
      {
        text: 'Ketua Lingkungan', value: 'id_ketua_lingkungan',
      },
      {
        text: '', value: 'action',
      },
  ...
  methods: {
    goToDetail(id) {
      this.$router.push(`/lingkungan/detail-lingkungan/${id}`)
    },
